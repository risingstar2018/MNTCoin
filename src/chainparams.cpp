...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04387bb6355c2adf1cb4f7880d515273a12ec72d16e951e14afaaafd80d5905172b43516d9e948be98047bb136aba5521b2671c58b9c3c7791cb0916918d80e2c1");
        nDefaultPort = 73588;
         ...
         */
        const char* pszTimestamp = "MNTrackerCoin new blockchain is here";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04280a21c252cbd88ae7067e536520bac66af1dc04685ffb308af1f5ab06feedd17b39b96deea9708ed6a65e18448123b9f65fb28c778aa03dcc7754984cb950be") << OP_CHECKSIG;
...
//      vSeeds.push_back(CDNSSeedData("seed2.cdmcoin.org", "seed2.cdmcoin.org"));             // seed2
        vSeeds.push_back(CDNSSeedData("54.188.227.54", "54.188.227.54"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 50); // C
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19); // x
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 217); // c
        ...
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x00)(0x08)(0x17).convert_to_container<std::vector<unsigned char> >();
